...
In addition to automated click detection, we used the PAMGUARD whistle and moan detector to detect tonal signals produced by marine mammals [@Gillespie2013]. After preliminary filtering of detections that were unlikely to be calls from manatees or delphinids, i.e. detections with maximum frequency lower than 2kHz and duration less than 0.1 seconds, the data set of tonal detections was negligible in size. Therefore, we did not include this dataset in downstream analysis of marine mammal occurrence at the farm.

...
```{r prop.interactions, fig.align = 'center', fig.cap = "Figure 3. Proportional delphinid interactions with the farm in each quarter and year of the study period at each farm locations, shown as the total number of interactions normalized by the acoustic monitoring effort."}
...
```{r dur.interations, fig.align = 'center', fig.cap = "Figure 4. Top: Mean duration of farm interactions each quarter and year at each farm location. Bottom: Number of farm interactions binned by duration."}
...
```{r interaction.model, fig.align = 'center', fig.cap = "Figure 5. Model selection table showing cumulative model weight of all models predicting the number of farm interactions during each recording period."}
...
```{r interaction_farm, fig.align = 'center', fig.cap = "Figure 6. Number of farm interactions by farm location."}

...
Several species of marine mammal (N = XX) inhabit the Gulf of Mexico, including two species of endangered baleen whale - Rice's whale (*Balaenoptera ricei*) and North Atlantic right whale (*Eubalaena glacialis*) - as well as the endangered Antillean manatee (*Trichechus manatus manatus*). **Fact check this sentence** Of these species, XX are coastally distributed around Puerto Rico.

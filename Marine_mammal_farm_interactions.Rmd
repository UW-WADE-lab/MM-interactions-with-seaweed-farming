...
We filtered annotated click events to include only those events with > 20 clicks over 150 dB. To determine this threshold, we estimated the expected amplitude of received echolocation signals from delphinids near the farm (<25 m) using the following equation for sound absorption in water (REF):
